...
export default function Footer() {
  ...
  return (
    <footer className="bg-azul-prof text-white pt-14 pb-8" aria-label="Rodapé">
      <div className="w-[min(92%,1240px)] mx-auto flex flex-wrap gap-8 justify-between items-start">
        <div>
